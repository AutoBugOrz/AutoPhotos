        ...
        private void addDragEvent() {
            if (content != null) {
                content.addEventHandler(MouseEvent.MOUSE_PRESSED, event -> {
                    ...
                    System.out.println("startX " + event.getSceneX() + " startY " + event.getSceneY() +
                            " startHvalue " + getHvalue() + " startVvalue " + getVvalue());
                    System.out.println("--------------------------------");
                    isDrag = false;
                });
                ...
                content.addEventHandler(MouseEvent.MOUSE_DRAGGED, event -> {
                    if (event.isPrimaryButtonDown()) {
                        ...
                        System.out.println("--------------------------------");
                        System.out.println("moveX " + moveX + " moveY " + moveY + " contentW " + content.getWidth()
                        + " contentH " + content.getHeight() + " width " + getWidth() + " height " + getHeight());
                        System.out.println("--------------------------------");
                        isDrag = true;
                    }
                });
